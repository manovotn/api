...
public interface WeldClientProxy extends WeldConstruct {
    ...
    /**
     * Retrieve contextual instance for this client proxy. Note that in some cases the contextual instance is still an instance
     * of {@link WeldConstruct}.
     *
     * @return Returns the underlying contextual instance of this client proxy instance.
     */
